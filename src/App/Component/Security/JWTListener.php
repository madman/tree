...
class JWTListener implements ListenerInterface {
    ...
    public function handle(GetResponseEvent $event)
    {
        ...
        if (empty($requestToken)) {
            $event->setResponse(new JsonResponse(['error' => 'Not found token in request'], JsonResponse::HTTP_UNAUTHORIZED));
        } else {
            try {
                ...
                $event->setResponse(new JsonResponse(['error' => 'Cannot encode token'], JsonResponse::HTTP_UNAUTHORIZED));
            } catch (\Exception $e) {
                $event->setResponse(new JsonResponse(['error' => 'Other authentication error'], JsonResponse::HTTP_UNAUTHORIZED));
            }
        }
    }
